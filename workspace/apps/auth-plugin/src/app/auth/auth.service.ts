...
import { UserService } from 'core/src/lib/users/user.service';
import { JwtService } from '@nestjs/jwt';
import * as bcrypt from 'bcrypt';
import { LoginInput } from './dto/login.input';
import { VerificationCodesService } from 'core/src/lib/verification-codes/verification-codes.service';
import { VerificationCode } from 'core/src/lib/verification-codes/verification-codes.entity';
import { CreateUserInput } from 'core/src/lib/users/dto/create.user';
