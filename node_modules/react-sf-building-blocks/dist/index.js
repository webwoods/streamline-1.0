...
var Themes = _interopDefault(require('react-sf-themes'));
...
var SfButton = function SfButton(_ref) {
  ...
  var _useState2 = React.useState('none'),
  ...
  }, caption, icon != null && React.createElement("span", {
    style: {
      paddingTop: '3px'
    }
  }, "\xA0", icon));
...
var SfInput = function SfInput(_ref) {
  ...
  var _useState14 = React.useState(new Date().getFullYear()),
  ...
  var refInputDD = React.useRef();
  var refInputMM = React.useRef();
  var refInputYYYY = React.useRef();
  var arrYears = [];
  ...
  return React.createElement("div", {
  ...
  }, icon != null && icon, icon != null && React.createElement("span", null, "\xA0\xA0"), React.createElement("span", {
    className: 'sf_input_caption',
    onClick: function onClick() {
      setFocus();
    }
  }, caption), React.createElement("span", null, "\xA0\xA0\xA0"), inputType == theme.inputTypes.mobile && React.createElement("div", {
    style: {
      display: 'flex',
    ...
    disabled: disabled
  }), showCountryCodes && React.createElement("div", {
    style: {
      position: 'fixed',
      bottom: '0px',
      left: '0px',
  ...
  })))), (inputType == theme.inputTypes.dateOfBirth || inputType == theme.inputTypes.date) && React.createElement("div", {
    style: {
      flexGrow: "1",
      display: 'flex',
  ...
  }, React.createElement("small", null, selectedYYYY)), React.createElement("div", {
    style: {
      width: '97px',
      marginTop: theme.spaces.ltl + 'px',
      marginLeft: theme.spaces.ltl + 'px',
  ...
  }, React.createElement("small", null, selectedMM === 0 ? "" : Util.toMonthName(selectedMM))), React.createElement("div", {
    style: {
      width: '30px',
      marginTop: theme.spaces.ltl + 'px',
      marginLeft: theme.spaces.ltl + 'px',
  ...
  }, React.createElement("small", null, selectedDD === 0 ? "" : selectedDD))), React.createElement(SfButton, {
    styles: {
      cursor: 'pointer',
      marginRight: theme.spaces.ltl + 'px',
      marginTop: theme.spaces.ltl + 'px'
    ...
    }, React.createElement("small", null, Util.toMonthName(month)));
  })), React.createElement("div", {
    style: {
      height: '150px',
      overflowY: 'auto'
    ...
    }, React.createElement("small", null, day.getDate()));
  }))))), inputType != theme.inputTypes.dateOfBirth && inputType != theme.inputTypes.date && React.createElement("input", {
...
var Banner = function Banner(_ref) {
  ...
  return React.createElement("div", null, showBanner && displayBanner && bannerComponent == null && React.createElement("div", {
  ...
  }, bannerText), React.createElement("div", {
    style: {
      display: "flex",
      alignItems: 'center'
    }
  ...
  })), bannerEnableDismiss && React.createElement("div", {
...
var Profile = function Profile(_ref2) {
  ...
  return React.createElement("div", {
  ...
  }, profilePicture.length > 0 && React.createElement("img", {
  ...
  }), React.createElement("small", null, React.createElement("small", null, !expandProfile && '▼', expandProfile && '▲'))), expandProfile && React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      alignItems: 'stretch',
  ...
  }), profilePreamble != null && React.createElement("div", {
    ...
    if (Object.prototype.toString.call(element) === '[object Array]') {
      return React.createElement("div", {
      ...
      }, getProfileDropdownExpandedWrap()[key] && React.createElement(SfButton, {
      ...
      }), getProfileDropdownExpandedWrap()[key] && React.createElement("div", {
        style: {
          flexDirection: 'column',
          position: 'absolute',
          right: '0px',
        ...
        return React.createElement(SfButton, {
  ...
  }), profileComponent != null && React.createElement("div", {
...
var ErrorNotFound = function ErrorNotFound() {
  ...
  }, React.createElement("br", null), React.createElement("br", null), React.createElement("b", null, React.createElement("h1", null, "Page Not Found")), React.createElement("b", null, "There is nothing here..."), React.createElement("br", null), React.createElement("br", null), React.createElement("br", null));
};
var SfNav = function SfNav(_ref4) {
  ...
  var _useState2 = React.useState(getWindowDimensions()),
    ...
    if (enableRouting) {
      ...
      var _ret = function () {
        ...
        setHistory(function (history) {
          return [].concat(history, [{
            link: "errornotfound",
            component: React.createElement(ErrorNotFound, null),
            args: null
          }]);
        });
      }();
  ...
  return React.createElement("div", null, React.createElement("div", {
  ...
  }, windowDimensions.width <= theme.breakpoints.tablet && React.createElement("div", {
    style: {
      position: 'relative'
    }
  ...
  }, React.createElement("b", null, backIcon == null ? '‹' : backIcon)), !showBack && React.createElement("div", {
  ...
  }, React.createElement("b", null, menuIcon == null ? '☰' : menuIcon)), React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
  ...
  }, brandLogo != null && brandLogo != "" && React.createElement("img", {
  ...
  }, showSignIn && React.createElement(SfButton, {
  ...
  }, React.createElement("div", null, notificationIcon != null ? notificationIcon : "🔔"), notificationListContainsUnRead() && React.createElement("div", {
  ...
  }, React.createElement("div", null, "0"))), showSearch && React.createElement("span", {
    style: {
      fontWeight: '800'
    }
  }, React.createElement("b", null, optionsIcon == null ? '⋮' : optionsIcon)), showProfile && React.createElement(Profile, {
    clickMenu: clickMenu,
    ...
    if (Object.prototype.toString.call(element) === '[object Array]') {
      ...
      }, getDropdownExpandedWrap()[key] && React.createElement(SfButton, {
      ...
      }), getDropdownExpandedWrap()[key] && React.createElement("div", {
        style: {
          width: theme.dimensions.menuWidth + 'px',
          flexDirection: 'column',
          position: 'absolute',
  ...
  }, showSearch && React.createElement(SfInput, {
  ...
  }))), showNotificationMenu && React.createElement(NotificationMenu, {
    variant: variant,
    theme: theme,
  ...
  }))), windowDimensions.width > theme.breakpoints.tablet && React.createElement("div", null, React.createElement(Banner, {
    variant: variant,
    theme: theme,
  ...
  }, React.createElement("b", null, backIcon == null ? '‹' : backIcon)), brandLogo != null && brandLogo != "" && React.createElement("img", {
    className: 'nav_brand_logo ' + classNameBrandLogo,
    src: brandLogo,
    onClick: function onClick() {
      if (enableRouting) {
    ...
    if (Object.prototype.toString.call(element) === '[object Array]') {
      ...
      }, element[0].caption, "\xA0", React.createElement("small", null, React.createElement("small", null, !getDropdownExpandedWrap()[key] && '▼', getDropdownExpandedWrap()[key] && '▲'))), getDropdownExpandedWrap()[key] && React.createElement("div", {
        style: {
          position: 'absolute',
          top: '30px',
          left: '0px',
  ...
  }, React.createElement("div", null, "0"))), showProfile && React.createElement(Profile, {
    clickMenu: clickMenu,
    toggleExpandProfile: toggleExpandProfile,
    toggleProfileDropdownExpandedWrap: toggleProfileDropdownExpandedWrap,
    setExpandProfile: setExpandProfile,
